...
| [P-20260717-signal-layer-framing-probe-pair](records/P-20260717-signal-layer-framing-probe-pair.md) | framing/advisor checkpoint (cross-tier, PRE-REGISTERED; operator adjudicates, blinded) | 07-17 | PENDING — record pre-registered before legs ran |
| [P-20260717-sol-code-reviewer-b20-known-answer](records/P-20260717-sol-code-reviewer-b20-known-answer.md) | review gates (cross-vendor known-answer, deviated: blinding breach via worktree refs at call 42; author-adjudicator) | 07-17 | subagent JSONL + goal ledgers as key; MAJOR-1 repro re-run first-hand |
