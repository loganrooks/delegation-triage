...
| R4 | Coding / agentic implementation | **opus xhigh** (`implementer` pin) — **effort-frontier probe OPEN (P-20260724, no flip pending a local pair):** vendor charts put opus-5 *medium* above opus-4.8 *max* at ~½ cost, but the medium-vs-xhigh shape is **Contested** across two vendor sources [W-024] | same | W-004, W-020, W-024 |
